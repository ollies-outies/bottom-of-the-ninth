...
label start:
    ...
    "In reality, they just finally got knocked off eachother's shoulders."
    ...
    "I figured, I aught to try my hand at helping."
    c "Scuse me, gents, I-"
    ...
    o "You got me there."
    a "You got me there." 
    "The twins nodded at eachother, then approached
    ...
    "Obviously, whoever was stretching the longest was the tallest, if only for a moment, but all things considdered... To say that they were identical twins would answer the question."
    ...
    "They let the offer sink in, then practically throw each other away, and strike dramatic posses"
    show shaw
    show ock
    o "Oh, I could never work with you again! You villain, cad, bully and theif!"
    ...
    "And just like that, back on eachother's shoulers."
    show s&o
    a "We'll behave."
