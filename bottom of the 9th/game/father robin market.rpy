...
label FatherRobinMarket:
    ...
    "Robin Fairweather. A mountain of a man, with a deep knowledge of the internal workings of spellcasting that could put Merlin to shame."
    ...
    "In between the cheering and uproars, Robin heard a higher calling; that of his deity, calling him to care for the weak."
    ...
    r "More than likely made by hand, by someone, somewhere."
    c "Ah. A classic."
    ...
    r "It is... what is right, Casey. It's unfortunate, that they've been forced to do something like this to simply survive, but I want what's best for them."
    "I looked at Robin, his eyes focused on his flock. He was more ragged than ever. Where once had stood a tall mountain of a man was now a mere hillside, worn down through hardships and strife."
    ...
    "He focused intently on the children. The ones selling holy lemonade decided to close up shop. They brought cups full of the stuff to the other kids."
    ...
    r "... Hm."
    "He stood in silence, considering his thoughts for a moment."
    c "...  The first game is in a few days. Hell Valley Stadium."
    c "I understand if you can't but... I'd love to see you there."
    "I let go of the gentle giant’s shoulder, picking up a charm as I did."
    c "If not for me, or you... then for them."
    hide robin
    "I paid the asking price for my charm, twice over. If this was gonna work, I wouldn't mind something swaying Fate more in my favor."
