...
label CilerenMarket:
    ...
    c "Issue with bright bulbs, though, is that they're the ones that burn out fastest."
    ...
    l "So, Whatchu’ got on stock? Pre-rolls? WMS? A goon-sack maybe?"
    ...
    c "How is that less suspicious than just actually winking?! Wait, what the fuck is a GOON SACK?"
    ...
    c "That's because I'm not one! I'm a coach, recruiting for a new pro Wizball team that's starting up in town."
    ...
    l "Oh, of course! And neither of us dignified folk would ever be looking for any ''Drug'', in the first place. To suggest such a thing would be folly, of the highest degree! Oh ho ho ho!"
    ...
    menu:
        ...
        "Oh, of course not, sport! And that's the proper thing to say to any of those drug turkeys who might come at'cha! Because, of course, you, as a star Wizardball player on my newly formed team, would never stoop to drugs. Ugh! ":
            jump cileren_a1
    
        "Why, I do agree, my dear compatriot! What utter foolishness. Drug usage would impair your unparalleled playing ability in our upcoming Wizardball game at Hell Stadium!":
            jump cileren_a2
    
    label cileren_a1:
    l "Why, that's right coach! I'd never go after anything like that, not even once! I say nope to dope – AND ugh to drugs!"
    ...
    c "In fact, I'm offering seats right now to you loyal citizens to watch us go and beat those fiends down in Hell! All you gotta do, is promise you'll all remember say no to drugs."
    "A few people walked up to claim tickets, saying things that'd fit perfectly in an after school special. The entire time, Cileren was glaring knives at me."
    jump cileren_a3
    
    label cileren_a2:
    l "Oh ho ho, my good individual, that's... That's true, that thing you just said."
    c "Indubitably so, pip pip! Truly, the splendiferous nature of merely playing the game is enough to get OUR jollies, now isn't it, madame?"
    ...
    l "Ah, sure! There... Sober as a nun! Here's hoping we don't throw too..."
    "She steps hard on my foot."
    l "HEAVY HANDEDLY. We might have to..."
    ...
    c "Yeah, I deserve that. But listen, all those folks are expecting to see you play. If they go and you aren't at least benchwarming, they're gonna know something's up. You've gotta be in, at least, this first game. I'll get you all the goonbags you want, after."
    l "It's goonSACK, brah. And fine, whatever."
    ...
    hide cileren
    "She apparated a skateboard, and got on, flicking up deuces as she took off into the market."
    "I was kind of hurt she didn't remember me, but not surprised. I was much older, after all. I mean, don't remember my 1st grade teacher."
    "... Did I actually introduce myself?"
    "Huh. I ought to remember to do that next time, with..."
