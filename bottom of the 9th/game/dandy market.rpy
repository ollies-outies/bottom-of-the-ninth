...
label DandyMarket:
    ...
    "Aly ‘Dandy’ Dupris got her start earlier than I did, and was a champion in her own right. Watching her play was truly something else. She lived and breathed classic Wizardball."
    "Unfortunately, what starts out as classic and vintage, slowly just turns to out of date."
    "To put it simply, the game evolved too fast, and she fell behind. New strategies. New rules. New players, that brought with them new abilities and skills."
    "She was a giraffe, albeit a short one, being a dwarf, and the tree branches of Wizardball grew too tall for her to reach."
    "Maybe it's time we got this giraffe some stilts."
    ...
    f "Oh, man alive! Casey Conrad, is that you, you rapscallion? I done been told you were colder than the grave by now!"
    c "Hey, you're one to talk, madame."
    ...
    f "Oh! Daggers, C.C.! You've wounded me, in ways that no one else can. Irreversible damage!"
    ...
    f "Likewise, ditto, and just the same, Casey. If you have something to say to me, then don't beat around the bush. I've a pinochle game at 5 that I mustn't be late for."
    "I should've known better than to play bullshit with Dandy."
    ...
    f "That I'll drop all prior obligations, pinochle club INCLUDED, to join your gang of cavorting rounders to play in the best sport known to sapient life?"
    ...
    label dandy_a2:
    "She gasped, dramatically, and blushed slightly"
    ...
    f "Well... I... I never... Shucks... Oh, my stars and garters... Misery me..."
    ...
    f "OH, THUNDER AND TOM WALKER, YOU'VE CONVINCED ME! BALDERDASH TO MY PINOCHLE GAME!"
    jump dandy_a3
    ...
    "She scoffed, and with a kick, that tote was in the air, then on her arm. One clean, practiced motion."
    f "No need, guttersnipe! No need."
    "Chortling, she went on her way."
    hide dandy
