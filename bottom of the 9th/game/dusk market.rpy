...
label DuskMarket:
    ...
    "They say curiosity killed the cat, but when it came to Dusk Darkness, curiosity made them more powerful than they ever could've imagined."
    ...
    y "HEY! PUNKOSAURUS!"
    y "N'you staring n'yat me or somethin'?!?"
    ...
    y "Maybe n'yi did! Maybe n'yi didn't! what's it to n'you!?"
    ...
    y "N'you tryna patronise me just cause N'yi'm fuzzy?! N'yi'll have n'you know n'yim n'yalergic to salmon!"
    c "I didn't get a single word of that. Anyways, I'm starting a Wizardball team, you in? or are you out?"
    y "Well... what would be n'yin it for me?"
    ...
    y "N'yi mean that was fun 'n n'yall but why would n'yi want to go back to playing when n'yi can harm whatever n'yi want whenever n'yi want?"
    c "Dusk, I'm pretty sure that's a felony."
    y "Well... N'yi don't know what that means so, take that! Besides wizardball has n'yall those dumb-stinky rules n'you need to worry n'yabout."
    c "That's... technically true dusk, but why just hurt people when you can hurt people and get a sport trophy about it?"
    y "Trophies N'yare N'ya capitalist monolith designed to quantify meningless n'yactions N'yin N'yorder to sate the masses just N'yenougn to keep them complacent! N'yor N'yat least that's what N'yit said N'yin the book N'yi N'ate last week..."
    ...
    y "Do n'you have n'yanything n'yelse to say n'yor n'yar n'you just gonna stand there like 'n'ya big dumb pile n'yof slugs'?"
    c "I feel like I should take offense to that but honestly I just don't have it in me right now."
    y "N'yoh n'yis that SO?! Dumb little slug pile wanna n'yeat some rocks n'yor something? Slugpile headass"
    jump dusk_B3
    ...
    y "N'you know what?! N'yive done some thinking n'yand…"
    y "N'yi wanna do it! Get me n'yon n'your team!"
    c "Alright!"
    y "N'yon N'yone condition."
    c "Fuck."
    y "N'yi get to be the team MASCOT! N'yincluding but not limited to: 50 percent n'yof n'yall team n'yearnings, t-shirts with me n'yon them doing something cool like breaking someones legs n'yor something, N'YAAAAAND, N'yif we win n'yi get to take the team to my favorite place to n'yeat n'yafterwords."
    y "SPOILER: N'yit's very cozy."
    y "SPOILER-SPOILER: N'yit's the sewer."
    c "So what you're putting down is if we do all that you'll play for the team?"
    y "Make n'yit 70 percent n'yof n'all n'yearnings n'yinstead n'yof 60 n'yand n'you got n'ya deal"
    c "Now now, wait just a very long second! Why did you go all the way up to 70?!"
    y "Consider n'yit colateral."
    c "Do you even know what that means, Dusk?"
    y "Well... no. But N'yi won't need to worry n'yabout that with n'yall the prize money n'yimma have!"
    ...
    y "They don't have TABS n'yin the sewer idiot! But N'yi'm in!"
