...
label FatherRobinStadium:
    ...
    "To those who know why he left, though, they hummed a different tune."
    ...
    "They were transfixed by the paintings and statues of players come and gone. They hadn't made one for me, yet, and something told me I wouldn't be around to see it, if they ever did."
    ...
    r "Ah, Casey Conrad Fisk. Brash as ever, I see."
    ...
    "He forced a smile. It wasn't disingenuous, it was just for something else."
    ...
    "He took a step back."
    r "The mighty C. C. Fisk, doing something other than Wizardball?"
    c "No, no, I didn't say that. For the first time in this conversation, you missed. I'm coaching a pro-team now. Stationed up here in Katabas, actually. Same stadium."
    "He let the information sit for a moment, and then let out a hearty laugh."
    r "Oh, I should have expected! No way that C.C. Fisk would ever get off that grassy hill. I was a fool to think otherwise."
    c "Yeah, yeah. Yuk it up. It's only fitting, honestly. New team's called ''The Comedians''."
    ...
    r "Casey Conrad... are you a good person?"
    ...
    "He thumped my head with the bottom of his fist. It hurt, but I suppose I deserved it."
