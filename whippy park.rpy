...
label start:
    ...
    "He was blessed from birth with an unusually high capacity for mana, which ment an unusually high potency spells. Love."
    ...
    "Which, why when I found him practicing his swing on the field itself, I think I knew what was running through his mind."
    ...
    "I shook my head."
    c "Kid, when you're only using one hand, it's all the bats weight, and none of your control that you bring with your arms. The forces add together, but with none of the benefits."
    ...
    "Whippy and I watched, as it flew across the entire span of field, and slammed smack into the goal post. If this were a real game, that distance would've gotten us at least 3 points."
    c "Nice shot, kid."
    w "... I... How did that..."
